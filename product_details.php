...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/<?php echo $productId ?>.jpg" title="<?php echo $productDetails['name'] ?>">
				<img src="themes/images/products/large/<?php echo $productId ?>.jpg" style="width:100%" alt="<?php echo $productDetails['name'] ?>" width="500" height="375"/>
            </a>
			</div>
			<div class="span6">
				<h3 class="itemName"><?php echo $productDetails['name'] ?></h3>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><?php echo $productDetails['price'] ?> мкд</span></label>
				  </div>
				</form>
				
				<hr class="soft"/>
				<h4><?php echo $productDetails['stock'] ?> продукти на залиха</h4>
